...
const About = () => {
  return (
    <div className='mb-8 relative flex flex-col lg:justify-center lg:flex-row lg:mb-16 lg:pr-[50px] lg:pl-[151px] lg:gap-6 gap-3 xl:pl-[248px] xl:pr-[147px]'>
            <img className='absolute w-32 -left-8 -top-4 -z-10 lg:w-44 lg:left-28 lg:-top-6 xl:w-60 xl:left-44 xl:-top-10' src={aboutBobble} alt="" />
        ...
        <div className='px-16 text-left sm:p-0 lg:w-[597px] lg:h-[372px] '>
